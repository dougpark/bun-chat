// public/vendor/icons.js

/**
 * ECS Icon Library
 * All icons are set to use stroke="currentColor" and stroke-width="2" 
 * so they can be styled easily with Tailwind text colors and sizes.
 */

/**
 * Many icons are from https://lucide.dev
 */
export const ICONS_SVG = {
    ...
    // Extreme weather (could be a tornado, hurricane, or other severe weather icon)
    ...
    // Back arrow (used in Chat, Profile, and Admin headers)
    ...
    // Paper plane (used in the Chat input area)
    ...
    // Users icon (used in Admin Nav and Bottom Nav)
    ...
    // Shield/Admin icon (used in Bottom Nav)
    ...
    // Bell/Check-in icon (used in Bottom Nav)
    ...
    // Single user/profile icon (used in Settings)
    ...
    // Log out icon (used in Settings)
    logout: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>`,

    // Pencil/Edit icon (used for supersede update indicator)
    pencil: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pencil"><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/><path d="m15 5 4 4"/></svg>`,

    // Arrow Up icon (used for superseded banner)
    arrowUp: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up"><path d="m5 12 7-7 7 7"/><path d="M12 19V5"/></svg>`,

    // Sparkle / AI summary icon
